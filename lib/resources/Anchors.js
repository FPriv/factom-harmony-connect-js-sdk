...
export default class Anchors {
  ...
  async get(params = {}) {
    ...
    const finalParam = !CommonUtil.isEmptyString(params.entryHash)
      ? params.entryHash : params.height;

    const response = await this.apiCall.send(constants.GET_METHOD,
      `${constants.ANCHORS_URL}/${finalParam}`, {}, params.baseUrl, params.accessToken);
