...
export default class Entries {
  ...
  async get(params = {}) {
    ...
    const response = await this.apiCall.send(constants.GET_METHOD, `${constants.CHAINS_URL}/${params.chainId}/${constants.ENTRIES_URL}/${params.entryHash}`);
  ...
  async getFirst(params = {}) {
    ...
    const response = await this.apiCall.send(constants.GET_METHOD, `${constants.CHAINS_URL}/${params.chainId}/${constants.ENTRIES_URL}/${constants.FIRST_URL}`);
  ...
  async getLast(params = {}) {
    ...
    const response = await this.apiCall.send(constants.GET_METHOD, `${constants.CHAINS_URL}/${params.chainId}/${constants.ENTRIES_URL}/${constants.LAST_URL}`);
  ...
  async create(params = {}) {
    ...
    const response = await this.apiCall.send(constants.POST_METHOD, `${constants.CHAINS_URL}/${params.chainId}/${constants.ENTRIES_URL}`, data);
  ...
  async list(params = {}) {
    ...
    const response = await this.apiCall.send(constants.GET_METHOD, `${constants.CHAINS_URL}/${params.chainId}/${constants.ENTRIES_URL}`, data);
