...
export default class Chains {
  ...
  async get(params = {}) {
    ...
    const response = await this.apiCall.send(constants.GET_METHOD,
      `${constants.CHAINS_URL}/${params.chainId}`,
      {}, params.baseUrl, params.accessToken);
  ...
  async create(params = {}) {
    ...
    const response = await this.apiCall.send(constants.POST_METHOD, constants.CHAINS_URL,
  ...
  async list(params = {}) {
    ...
    const response = await this.apiCall.send(constants.GET_METHOD, constants.CHAINS_URL,
      data, params.baseUrl, params.accessToken);
