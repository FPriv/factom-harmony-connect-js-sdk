...
export default class KeyUtil {
  ...
  /**
   * @param  {String} signerKey='' - A base58 string in idpub or idsec format
  ...
  /**
   * @param  {String[]} signerKeys=[] - Array base58 string in idpub or idsec format
   * @return  {Object[]} Returns errors array when keys have at least 1 item(s) is invalid.
   */
  ...
  /**
   * @param  {String} privateKey='' - A base58 string in idpub or idsec format
  ...
  /**
   * @param  {String} privateKey='' - A base58 string in idsec format
   * @param  {String} message='' - A plain text.
  ...
  /**
   * @param  {String} publicKey='' - A base58 string in idpub format
   * @param  {String} signature='' - A base 64 string format
   * @param  {String} message='' - A plain text
